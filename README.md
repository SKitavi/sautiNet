...
pip install fastapi uvicorn[standard] pydantic pydantic-settings transformers torch tokenizers sentencepiece httpx aiohttp aiofiles websockets python-dotenv python-multipart
