...
class NLPPipeline:
    ...
    def __init__(
        ...
        self.sentiment_engine = SentimentEngine(sheng_tokenizer=self.sheng_tokenizer)
    ...
    def get_pipeline_stats(self) -> dict:
        ...
        return {
            ...
            "components": {
                ...
                "sentiment_engine": "transformer" if self.sentiment_engine._model_loaded else "rule-based",
